...
public class ItemVariable extends Item {
    ...
    /** Returns a predicate that matches blank variables (e.g. variables with dummy facade) */
    public Predicate<ItemStack> blankVariablePredicate(Level level) {
        ValueDeseralizationContext context = ValueDeseralizationContext.of(level);
        return itemStack -> itemStack.is(this) &&
                getVariableFacade(context, itemStack) == VariableFacadeHandlerRegistry.DUMMY_FACADE;
    }
}
